...
class Swiper extends Component {
  ...
  static propTypes = {
    ...
    scrollViewContentContainerStyle: PropTypes.oneOfType([PropTypes.object, PropTypes.number]),
  ...
  renderScrollView = pages => {
    return (
      <ScrollView
        ...
        contentContainerStyle={[styles.wrapperIOS, this.props.scrollViewContentContainerStyle]}
