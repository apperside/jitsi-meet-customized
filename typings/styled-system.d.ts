...
declare module "styled-system" {
  ...
  export interface Theme<TLength = TLengthStyledSystem, Strict = true> {
    ...
    borderWidths: ObjectOrArray<CSS.BorderWidthProperty<TLength>, keyof ThemeBorderWidths>;
  ...
  export interface SpaceProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeSpaces | number> {
  ...
  /**
  * If we want a fully typed system and allow as a string
  * only the theme values, we can't allow any string value in the type
  * For example if we allof values like this
  *
  * keyof ThemeFontSizes | string
  *
  * the sizes we will use will not be type-validated.
  * There are 2 options to overcome this opinionated decision:
  *
  * 1- augment the definitions and declare every single out of theme value:
  *
  * declare module "styled-system" {
  *     export interface ThemeFontSizes {
  *         small: string
  *         medium: string
  *         big: string,
  *         "1.1rem": string <-- out of theme value
  *
  *     }
  * }
  *
  * 2 - augment the definitions and allow any value
  *
  * declare module "styled-system" {
  *     export interface ThemeFontSizes {
  *         small: string
  *         medium: string
  *         big: string,
  *         {[key: string]: string} <-- allow any value
  *
  *     }
  * }
  *
  */
  export interface FontSizeProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeFontSizes | number> {
    /**
  ...
  export interface FontFamilyProps<ThemeType extends Theme = RequiredTheme> {
    fontFamily?: ResponsiveValue<keyof ThemeFontFamilies, ThemeType>;
  }
  ...
  export interface FontWeightProps<ThemeType extends Theme = RequiredTheme, TVal = ThemeValue<"fontWeights", ThemeType>> {
     ...
     */
    fontWeight?: ResponsiveValue<TVal | CSS.FontWeightProperty, ThemeType>;
  }
  ...
  export interface WidthProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeSizes | number> {
    /**
  ...
  export interface MaxWidthProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeSizes | number> {
    /**
  ...
  export interface MinWidthProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeSizes | number> {
    /**
  ...
  export interface MaxHeightProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeSizes | number> {
    /**
  ...
  export interface MinHeightProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeSizes | number | string> {
    /**
  ...
  export interface BorderWidthProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeBorderWidths | number> {
    /**
  ...
  export interface BorderStyleProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    borderStyle?: ResponsiveValue<keyof ThemeBorderStyles | CSS.BorderStyleProperty, ThemeType>;
    /**
     * The border-top-style CSS property sets the line style of an element's top border.
     *
     * [MDN * reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-style)
     */
    borderTopStyle?: ResponsiveValue<keyof ThemeBorderStyles | CSS.BorderTopStyleProperty, ThemeType>;
    /**
     * The border-bottom-style CSS property sets the line style of an element's bottom border.
     *
     * [MDN * reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-style)
     */
    borderBottomStyle?: ResponsiveValue<keyof ThemeBorderStyles | CSS.BorderBottomStyleProperty, ThemeType>;
    /**
     * The border-left-style CSS property sets the line style of an element's left border.
     *
     * [MDN * reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-left-style)
     */
    borderLeftStyle?: ResponsiveValue<keyof ThemeBorderStyles | CSS.BorderLeftStyleProperty, ThemeType>;
    /**
     * The border-right-style CSS property sets the line style of an element's right border.
     *
     * [MDN * reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-right-style)
     */
    borderRightStyle?: ResponsiveValue<keyof ThemeBorderStyles | CSS.BorderRightStyleProperty, ThemeType>;
  }
  ...
  export interface BorderTopProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeBorders | CSS.BorderTopProperty<TLengthStyledSystem>> {
    /**
  ...
  export interface BorderRightProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeBorders | CSS.BorderRightProperty<TLengthStyledSystem>> {
    /**
  ...
  export interface BorderBottomProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeBorders | CSS.BorderBottomProperty<TLengthStyledSystem>> {
    /**
  ...
  export interface BorderLeftProps<ThemeType extends Theme = RequiredTheme, TVal = keyof ThemeBorders | CSS.BorderLeftProperty<TLengthStyledSystem>> {
    /**
  ...
  export interface TopProps<ThemeType extends Theme = RequiredTheme, TVal = (keyof ThemeSpaces) | "auto" | number | string> {
    /**
